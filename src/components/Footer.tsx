        ...
        <div className="flex flex-col md:flex-row items-start md:items-center justify-between gap-8">
          ...
          <div className="flex flex-col sm:flex-row gap-8">
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm">
                <li><Link to="/cars?category=SUV" className="hover:text-white transition-colors">SUVs</Link></li>
                <li><Link to="/cars?category=Sedan" className="hover:text-white transition-colors">Sedans</Link></li>
                <li><Link to="/cars?category=Electric" className="hover:text-white transition-colors">Electric</Link></li>
                <li><Link to="/cars?category=Convertible" className="hover:text-white transition-colors">Convertibles</Link></li>
              </ul>
            </div>
          </div>
        </div>
